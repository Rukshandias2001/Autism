          ...
          <div className="new-al-content">
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="new-al-player-info">
                    <h2 className="new-al-video-title">
            ...
            <section className="new-al-playlist-section">
              <div className="new-al-section-header">
                ...
                <span className="new-al-video-count">
                    ...
                    >
                      ...
                      >
                        <div className="new-al-thumbnail-image">
                          ...
                          <div
                            className="new-al-thumbnail-fallback"
                            style={{ display: v.thumbnail ? "none" : "flex" }}
                          >
                        ...
                        <div className="new-al-thumbnail-content">
                          <p className="new-al-thumbnail-title">
                            {v.title || "Untitled"}
                          </p>
                          <span className="new-al-thumbnail-number">
                            Video {index + 1}
                          </span>
                        </div>
                      </button>
                ...
                {isMentor && videos.length < MAX_VIDEOS && (
                  ...
                  >
                    <div className="new-al-add-content">
                      ...
                      <span className="new-al-add-hint">
                        {canAddMore ? "Click to upload" : "Limit reached"}
                      </span>
                    </div>
                  </button>
                )}
                ...
                <form className="new-al-form" onSubmit={onAdd}>
                  ...
                  <div className="new-al-form-group">
                    ...
                    <input
                      ...
                      required
                    />
                    <span className="new-al-form-hint">
                      Paste the full video URL from YouTube or Vimeo
                    </span>
                  </div>
                  ...
                  <div className="new-al-form-actions">
                    ...
                    <button
                      type="submit"
                      className="new-al-btn new-al-btn-primary"
                    >
                      <svg
                        width="20"
                        height="20"
